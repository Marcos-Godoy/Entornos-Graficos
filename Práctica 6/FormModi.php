...
<td width="243"> <input type="TEXT" name="ciudad" size="20" maxlength="20" value="<?php echo($fila['ciudad']); ?>">
</td>
</tr>
<tr>
...
<td width="243"> <input type="TEXT" name="tieneMetro" size="20" maxlength="40" value="<?php echo($fila['tieneMetro']); ?>">
</td>
</tr>
<tr>
